...
description: 'When working with shell scripts in Linux, you''ll often encounter two
  ways to execute .sh files: using ./ or by explicitly calling bash. While both methods
  can run the script, they work in little diffe…'
pubDate: '2025-11-09'
tags:
- linux
- bash
